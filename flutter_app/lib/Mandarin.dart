...
class Mandarin extends StatefulWidget {
  @override
  State<Mandarin> createState() => _MandarinState();
}

class _MandarinState extends State<Mandarin> {
            ...
            child: Column(
              children: [
                Container(
                  ...
                  height: 260,
                  width: 200,
                  child: Image.asset('images/mandarin.png'),
                ),
                Row(
