...
import 'package:flutter_app/CartScreen.dart';

import 'AppColors.dart';

// ignore: must_be_immutable
class OrangeShop extends StatefulWidget {
  int count = 0;
  String typeOfFruit = "Orange";

  @override
  State<OrangeShop> createState() => _OrangeShopState();
}

class _OrangeShopState extends State<OrangeShop> {
                            ...
                            Navigator.push(
                                ...
                                MaterialPageRoute(
                                    builder: (context) => CartScreen(
                                        widget.count, widget.typeOfFruit)));
                          },
                          style: ButtonStyle(
